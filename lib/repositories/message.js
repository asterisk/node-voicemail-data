...
function createApi(table, provider, sqlGenerator, dependencies) {
  ...
  return {
     ...
     */
    countFolder: function(folder) {
      dependencies.logger.trace('message.countFolder called');
    ...
    /**
     * Deletes all messages belonging to a specific mailbox
     */
    removeMailbox: function remove(mailbox) {
      dependencies.logger.trace('message.removeMailbox called');
