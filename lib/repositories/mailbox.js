...
function createApi(table, provider, sqlGenerator, dependencies) {
  ...
  return {
    ...
    /**
     * Return all mailboxes belonging to the specified context
     */
    allContext: function(context) {
      dependencies.logger.trace('mailbox.allContext called');
      ...
      function constructor(id) {
        ...
        return this.create(undefined, context, undefined, id);
      }
     ...
     */
    countContext: function(context) {
      dependencies.logger.trace('mailbox.countCoxt called');
